export default function Results({searchResults, totalResults, handleNominate}) {
  return (
    <div>
      <div>{totalResults}</div>
      {searchResults && searchResults.map((result) => (
        <div key={result.imdbID}>
          <img src={result.Poster !== "N/A" ? result.Poster : "./poster-placeholder.png"} alt={result.Title}/>
